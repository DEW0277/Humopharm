  ...
  return (
    <nav className="max-md:flex hidden p-4 items-center justify-between">
      ...
      <div className="flex items-center">
        ...
        <Button
          size={"icon"}
          className="ml-2 bg-[#D93D40] hover:bg-[#D93D40]/90 rounded-xl cursor-pointer"
          onClick={toggleMenu}
        >
          <RiApps2Fill className="size-6 text-white" />
        </Button>
        <div
          className={`w-full px-4 py-6 fixed top-0 left-0 bg-white z-[9999]!  transition-transform duration-300 ${
        ...
        >
          <div className="w-full flex items-start justify-between">
            ...
            <Button
              size={"icon"}
              className="mt-6 bg-[#D93D40] hover:bg-[#D93D40]/90 rounded-full cursor-pointer"
              onClick={toggleMenu}
            >
          ...
          <div className="w-full flex items-center justify-between mt-4 flex-wrap gap-2.5">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <p className="m-0">
                Tel: <br />
                <span className="font-medium text-[#6b6b6b] block">+998 00 000 00 00</span>
              </p>
            </div>{" "}
          </div>
        </div>
