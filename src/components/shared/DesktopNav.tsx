...
function DesktopNav() {
    return (
        <nav className="hidden md:flex bg-[#d93c40] mb-5 text-white rounded-[22px] w-[92%] max-w-[1200px] mx-auto p-3 sm:p-4 flex-col sm:flex-row items-center sm:justify-between gap-4 relative z-10">
