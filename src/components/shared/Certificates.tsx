...
function Certificates() {
  return (
    <section className="mt-[200px]">
      <div className="relative flex flex-col md:flex-row items-center md:items-start gap-4 bg-gradient-to-b from-[#ec5256] via-[#d93d40] to-[#a61f22] rounded-[18px] p-6 text-white overflow-hidden w-full max-w-[1320px] mx-auto min-h-[676px]">
        ...
        {/* Карусель */}
        <div className="mt-12 flex justify-center md:justify-start w-full relative">
          <Carousel
            opts={{
              align: "start",
              loop: true,
          ...
          {/* Декор внизу (тоже можно скрыть на мобилке, если мешает) */}
